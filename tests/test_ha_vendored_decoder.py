...
def test_known_1649_measurement() -> None:
    weight = bytes.fromhex(
        "1D A4 1F 00 FE 75 FA 20 1F 0D 13 00 FF 01 09 00 00 00 00"
    )
    features = bytes.fromhex(
        "6F 75 FA 20 1F 01 B9 0A C8 F0 69 F2 79 F1 20 F0 00 00 00"
    )
